...
| Structure as a lintable contract (optional SCHEMA.md seeding, `plant --schema`) | bamr87/SCHEMA | One `SCHEMA.md` per directory; the pyramid describes the pyramid; implemented in kernel v0.1.1 |
